...
export const metadata: Metadata = {
  title: 'Umbraco Services - Aaitek Technology Specialists',
  description: 'Build beautiful, scalable websites with Umbraco, the friendly and flexible .NET CMS.',
};
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-40">
            <div className="text-left text-white px-4 max-w-4xl">
              <h1 className="text-4xl md:text-5xl font-bold mb-4 text-left">
                The Friendly CMS with Umbraco
              </h1>
              <p className="text-lg md:text-xl leading-relaxed text-left">
                Build beautiful, scalable websites with Umbraco, the friendly and flexible .NET CMS.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-7">
              <div className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Umbraco is the friendly, flexible, and fast-growing ASP.NET CMS. Loved by developers and
                  content editors alike, Umbraco provides the perfect balance of power and simplicity.
                  Build anything from simple websites to complex enterprise solutions.
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gray-50 p-6 rounded-lg">
                    ...
                    <p className="text-gray-600 text-sm">
                      Built on .NET with clean MVC architecture and extensive customization options.
                    </p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <h4 className="font-semibold text-gray-800 mb-2">Content First</h4>
                    <p className="text-gray-600 text-sm">
                      Intuitive content editing experience with powerful tools for content creators.
                    </p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <h4 className="font-semibold text-gray-800 mb-2">Scalable</h4>
                    <p className="text-gray-600 text-sm">
                      From small sites to enterprise solutions, Umbraco scales with your needs.
                    </p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <h4 className="font-semibold text-gray-800 mb-2">Open Source</h4>
                    <p className="text-gray-600 text-sm">
                      Free, open-source with a vibrant community and commercial support options.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-5">
              <div className="bg-blue-900 text-white p-6 rounded-lg sticky top-4">
                <h4 className="text-2xl font-bold mb-4">Ready to Build with Umbraco?</h4>
                <p className="mb-6 text-blue-100">
                  Experience the joy of working with a CMS that both developers and editors love.
                </p>
                <Link href="/contact">
