...
export const metadata: Metadata = {
  title: 'Sitecore XM Cloud Services - Aaitek Technology Specialists',
  description: 'Accelerate your digital transformation with Sitecore XM Cloud, the composable DXP.',
};

export default function XMCloudPage() {
  return (
    <div className="bg-white">
      <section className="relative">
        <div className="relative w-full">
          <Image
            src="/img/services-xm-cloud.png"
            alt="Sitecore XM Cloud Services Banner"
            width={1200}
            height={600}
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-40">
            <div className="text-left text-white px-4 max-w-4xl">
              <h1 className="text-4xl md:text-5xl font-bold mb-4 text-left">
                Composable DXP with Sitecore XM Cloud
              </h1>
              <p className="text-lg md:text-xl leading-relaxed text-left">
                Accelerate your digital transformation with Sitecore XM Cloud, the composable DXP.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="lg:col-span-7">
              <div className="mb-8">
                <h2 className="text-3xl font-bold mb-4 text-gray-800">
                  Why Sitecore XM Cloud?
                </h2>
                <p className="text-gray-600 leading-relaxed">
                  Sitecore XM Cloud is a cloud-native, composable digital experience platform that combines
                  the power of headless CMS with the flexibility of modern development frameworks.
                  Build faster, scale effortlessly, and deliver exceptional digital experiences.
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gray-50 p-6 rounded-lg">
                    ...
                    <p className="text-gray-600 text-sm">
                      Built for the cloud with automatic scaling, updates, and enterprise-grade security.
                    </p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <h4 className="font-semibold text-gray-800 mb-2">Composable Architecture</h4>
                    <p className="text-gray-600 text-sm">
                      Mix and match best-of-breed technologies to create your ideal tech stack.
                    </p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <h4 className="font-semibold text-gray-800 mb-2">Developer Experience</h4>
                    <p className="text-gray-600 text-sm">
                      Modern development tools, frameworks, and workflows that developers love.
                    </p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <h4 className="font-semibold text-gray-800 mb-2">Personalization</h4>
                    <p className="text-gray-600 text-sm">
                      AI-powered personalization and optimization capabilities built-in.
                    </p>
                  </div>
                </div>
              </div>
