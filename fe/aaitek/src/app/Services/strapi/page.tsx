...
export const metadata: Metadata = {
  title: 'Strapi Services - Aaitek Technology Specialists',
  description: 'Build powerful APIs and content management systems with Strapi, the leading open-source headless CMS.',
};
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-40">
            <div className="text-left text-white px-4 max-w-4xl">
              <h1 className="text-4xl md:text-5xl font-bold mb-4 text-left">
                Open-Source Headless CMS with Strapi
              </h1>
              <p className="text-lg md:text-xl leading-relaxed text-left">
                Build powerful APIs and content management systems with Strapi, the leading open-source headless CMS.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gray-50 p-6 rounded-lg">
                    ...
                    <p className="text-gray-600 text-sm">
                      100% open-source with no vendor lock-in and full control over your data.
                    </p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <h4 className="font-semibold text-gray-800 mb-2">Self-Hosted</h4>
                    <p className="text-gray-600 text-sm">
                      Deploy anywhere you want - on-premises, cloud, or edge computing.
                    </p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <h4 className="font-semibold text-gray-800 mb-2">Customizable</h4>
                    <p className="text-gray-600 text-sm">
                      Fully customizable with plugins, custom fields, and extensible architecture.
                    </p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <h4 className="font-semibold text-gray-800 mb-2">RESTful & GraphQL</h4>
                    <p className="text-gray-600 text-sm">
                      Auto-generated REST and GraphQL APIs for seamless integration.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-5">
              <div className="bg-blue-900 text-white p-6 rounded-lg sticky top-4">
                <h4 className="text-2xl font-bold mb-4">Ready to Build with Strapi?</h4>
                <p className="mb-6 text-blue-100">
                  Start your next project with the flexibility and power of open-source headless CMS.
                </p>
                <Link href="/contact">
