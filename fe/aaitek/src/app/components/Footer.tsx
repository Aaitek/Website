      ...
      <div className="container mx-auto py-8">
        <footer className="text-muted">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/blogs" className="hover:text-yellow-400">Blog</Link></li>
              </ul>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm">© Aaitek Technology Specialist 2024 | Designed and Developed by <a href="https://www.aaitek.com.au" className="hover:text-yellow-400">Aaitek Pty Ltd.</a></p>
