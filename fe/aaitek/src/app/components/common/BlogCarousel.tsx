      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-center">
          <div className="col-span-1">
            <h6 className="uppercase tracking-widest text-indigo-600 font-semibold">Inspiration</h6>
            <h2 className="text-4xl font-bold my-4 text-gray-900">Blogs & News</h2>
            <p className="mb-6 text-gray-700">
              Get inspired by our experts in Digital Transformation, Customer Experience, Commissioning, and IT.
            </p>
            <Link href="/events" className="inline-flex items-center bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-3 rounded-full shadow-lg transition duration-300">
              Discover more
              ...
              {blogs.map((blog, index) => (
                <SwiperSlide key={index} style={{ width: '320px' }}>
                  <div className="bg-white rounded-xl shadow-xl overflow-hidden">
                    ...
                    />
                    <div className="p-5">
                      <p className="text-xs uppercase text-indigo-500">Insight</p>
                      <h6 className="font-semibold text-lg text-gray-800 mt-2">{blog.title}</h6>
                    </div>
                  </div>
                </SwiperSlide>
              ))}
