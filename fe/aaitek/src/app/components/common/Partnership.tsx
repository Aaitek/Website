    ...
    <section className="container mx-auto my-16 px-4">
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 mb-16">
        ...
        <div>
          <Image
            ...
            className="mb-6"
          />
          <h6 className="text-[#FBD506] uppercase tracking-widest font-semibold mb-3">Partnerships</h6>
          <h2 className="text-3xl lg:text-4xl font-bold mb-5 text-[#1C1C1C]">
            Microsoft and Aaitek Strategic Partners in Digital Transformation
          </h2>
          <p className="mb-6 text-[#2E2E2E] leading-relaxed">
          ...
          <button className="bg-[#FBD506] hover:bg-[#e2c700] text-[#1C1C1C] font-semibold px-5 py-3 rounded-full inline-flex items-center shadow-lg transition duration-300">
            Read More
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10">
        <div>
          ...
          <h6 className="text-[#FBD506] uppercase tracking-widest font-semibold mb-3">Partnerships</h6>
          <h2 className="text-3xl lg:text-4xl font-bold mb-5 text-[#1C1C1C]">
            Sitecore & Aaitek Platinum Implementation Partner
          </h2>
          <p className="mb-6 text-[#2E2E2E] leading-relaxed">
